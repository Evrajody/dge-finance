...
<template>
  <div class="">
    ...
    <ArticleBanner :title="fakeArticle.getArticles[9].title" :image="fakeArticle.getArticles[5].media" />
    ...
    <div class="my-20 mx-auto lg:container">
      ...
      <div class="flex flex-col space-y-6 lg:flex-row lg:gap-0 lg:space-x-6">
        ...
        <div class="px-5 w-full lg:max-w-[68%]">
          ...
          <div class="mt-3 leading-6 text-finance-plot">
            <div class="post-content cf entry-content content-spacious">
              ...
              <p class="leading-7">Depuis le lancement de nos activités, au Sénégal en 2018, nous avons
              ...
              <p class="leading-7">Par ailleurs, nous avons également développé une offre de services B2B
              ...
              <p class="leading-7">Pour finir, nous travaillons activement sur plusieurs autres produits
        ...
        <div class="flex flex-col flex-1 px-3 space-y-6 order-articles">
          ...
          <div data-aos="fade-up" data-aos-anchor-placement="top-bottom" class="flex gap-3 w-full border-b-4 shadow bg-finance-gray border-b-finance-blue" v-for="i, index in 6">
            <div class="w-24 h-24 image">
              ...
              <img :src="fakeArticle.getArticles[index].media" class="w-full h-full" alt="">
            </div>

            <div class="flex flex-col flex-1 justify-center space-y-2 title">
              <span class="text-sm font-bold text-finance-late line-clamp-2"> {{ fakeArticle.getArticles[index].title }} </span>
