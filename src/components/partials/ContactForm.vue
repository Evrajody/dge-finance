...
<template>
  ...
  <div class="w-full px-5 lg:px-0 lg:max-w-2xl flex flex-col space-y-10">
    <div class="">
      <h3 class="text-lg font-medium text-finance-plot"> Avez - vous une préoccupations ? Ecrivez-nous ! </h3>
    </div>
