...
<template>
   <!-- <div class="form1">
      ...
      <div class="flex flex-wrap -mx-3">
         <div class="w-full md:w-1/2 px-3">
            <a href=""
               class="block border rounded py-2 pr-3 bg-finance-blue text-white hover:bg-finance-plot text-center">Stage
               Académique</a>
         </div>
         <div class="w-full md:w-1/2 px-3">
            <a href=""
