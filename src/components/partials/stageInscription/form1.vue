   ...
   <div class="form1">
      <div class="flex flex-wrap -mx-3 mb-6">
         ...
         <div class="w-full md:w-1/2 px-3">
            <label class="block tracking-wide text-gray-700 text-sm mb-2" for="grid-last-name">
               Prénoms
            </label>
            <input
      ...
      <h4 class="mb-5 text-center">Type de stage</h4>
      <div class="flex flex-wrap -mx-3">
         <div class="w-full md:w-1/2 px-3">
            <a href="" class="block border rounded py-2 pr-3 bg-finance-blue text-white hover:bg-finance-plot text-center">Stage
               Académique</a>
         </div>
         <div class="w-full md:w-1/2 px-3">
            <a href="" class="block border rounded py-2 pr-3 bg-finance-blue text-white hover:bg-finance-plot text-center">Stage
